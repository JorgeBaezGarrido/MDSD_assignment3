...
public class MathCompilerGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ExpressionsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "mdsd.MathCompiler.Expressions");
	...
	public class MathExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "mdsd.MathCompiler.MathExp");
		...
		private final RuleCall cLineGivenStringParserRuleCall_1_0 = (RuleCall)cLineAssignment_1.eContents().get(0);
		...
		//GivenString
		public RuleCall getLineGivenStringParserRuleCall_1_0() { return cLineGivenStringParserRuleCall_1_0; }
	...
	public class GivenStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "mdsd.MathCompiler.GivenString");
	...
	public class ExpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "mdsd.MathCompiler.Exp");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FactorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "mdsd.MathCompiler.Factor");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PrimaryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "mdsd.MathCompiler.Primary");
		...
		private final RuleCall cExponentParserRuleCall_4 = (RuleCall)cAlternatives.eContents().get(4);
		
		//Primary Expression:
		//	Number | Parenthesis | VariableBinding | VariableUse | Exponent;
		@Override public ParserRule getRule() { return rule; }
	...
	public class ExponentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "mdsd.MathCompiler.Exponent");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final RuleCall cBaseINTTerminalRuleCall_1_0 = (RuleCall)cBaseAssignment_1.eContents().get(0);
		...
		private final RuleCall cExponentINTTerminalRuleCall_3_0 = (RuleCall)cExponentAssignment_3.eContents().get(0);
		...
		//INT
		public RuleCall getBaseINTTerminalRuleCall_1_0() { return cBaseINTTerminalRuleCall_1_0; }
		...
		//INT
		public RuleCall getExponentINTTerminalRuleCall_3_0() { return cExponentINTTerminalRuleCall_3_0; }
	}
	public class VariableUseElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "mdsd.MathCompiler.VariableUse");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VariableBindingElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "mdsd.MathCompiler.VariableBinding");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ParenthesisElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "mdsd.MathCompiler.Parenthesis");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class NumberElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "mdsd.MathCompiler.Number");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private final GivenStringElements pGivenString;
	...
	public MathCompilerGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pGivenString = new GivenStringElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("mdsd.MathCompiler".equals(grammar.getName())) {
				return grammar;
			}
	...
	//GivenString:
	//	STRING;
	public GivenStringElements getGivenStringAccess() {
		return pGivenString;
	}
	
	public ParserRule getGivenStringRule() {
		return getGivenStringAccess().getRule();
	}
